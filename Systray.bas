...
Private Const APP_SYSTRAY_ID = 9998 'unique identifier
...
Public Sub ShellTrayAdd(Tip As String)
...
End Sub
'IconIndex 0=no icon; 1=info; 2=warning; 3=error

Public Sub ShellTrayModifyTip(nIconIndex As Long, InfoTitle As String, Info As String)
